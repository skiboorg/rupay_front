  ...
  <q-page padding>
    <section class="">
      <div class="container">
        ...
        <p class="text-h6 text-primary"><a style="text-decoration: underline" target="_blank" href="https://xn--k1affs.xn--p1ai/chicken_bro_info.pdf">Презентация ЧикенБро</a></p>
...
<!--              <q-img fit="contain" src="~assets/market/1.jpg"/>-->
<!--          </div>-->
<!--          <div class="col-12 col-sm-6 col-md-4">-->
<!--            <q-img fit="contain" src="~assets/market/2.jpg"/>-->
<!--          </div>-->
<!--          <div class="col-12 col-sm-6 col-md-4">-->
<!--            <q-img fit="contain" src="~assets/market/3.jpg"/>-->
<!--          </div>-->
